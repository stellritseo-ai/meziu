...
const KITCHEN_FAQS = [
  ...
  },
  {
    ...
    a: "Absolutely! We offer 100% free, no-obligation in-home estimates across Garfield, NJ, and our entire 40-mile service radius. Luan Meziu will visit your home, measure your kitchen, discuss your vision, and provide a clear written estimate.",
  },
  {
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-slate-100 group">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 p-5 rounded-2xl bg-white/95 backdrop-blur-md border border-slate-200/80 shadow-xl space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-black uppercase text-[#E56E1A] tracking-wider">Garfield, NJ Kitchen Specialists</span>
          ...
          <div className="container-x mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div className="text-center max-w-3xl mx-auto space-y-4">
              ...
              <p className="text-lg text-slate-600 font-medium">
                Comprehensive Solutions for Every Kitchen across Garfield &amp; Northern New Jersey
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-3 max-w-2xl">
                ...
                <p className="text-base text-slate-600">
                  Real Projects. Real Quality. Browse examples of our recent kitchen remodeling projects across Garfield, NJ, and Northern New Jersey.
                </p>
              </div>
          ...
          <div className="container-x mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div className="text-center max-w-2xl mx-auto space-y-2">
              ...
              <p className="text-sm text-slate-600">
                We provide expert kitchen remodeling services within a 40-mile radius of Garfield, NJ, including:
              </p>
            </div>
          ...
          <div className="container-x mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center space-y-8">
            ...
            <div className="pt-6 border-t border-white/20 max-w-3xl mx-auto">
              <p className="text-xs sm:text-sm text-white/85 italic leading-relaxed">
                "{BUSINESS.name} is a family-owned, licensed, and insured kitchen remodeling contractor serving Garfield, NJ, and a 40-mile radius since 2009. We are committed to quality craftsmanship, transparency, and customer satisfaction—from the first design to the final finishing touch."
              </p>
            </div>
